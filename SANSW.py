...
user = swcfg.sw_username()
passwd = swcfg.sw_password()
...
if __name__ == '__main__':
   ...
   # Status(host,port,username,password,lstPort)._PutErrorToDict()
    s1 = Status(host, port, username, password, lstPort).switch_status()
    print(s1)
