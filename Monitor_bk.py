...
def sansw_judge(total_sw, total_DB, sansw_IP, sansw_Alias):
...
def sansw_check():
    ...
    try:
        for i in range(len(lst_sansw_Alias)):
            ...
            sansw_judge(total_DB, total_sansw, lst_sansw_IP[i], lst_sansw_Alias[i])
    finally:
